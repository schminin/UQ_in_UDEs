...
problem_name = ARGS[1] # problem_name = "seir"
experiment_name = ARGS[2] # experiment_name = "negbin_IR_1.2"
...
if noise_model=="negBin"
    include("negbin_initialization.jl")
else
    include("gaussian_initialization.jl")
end

p_start = load(joinpath(pwd(), "experiments/ensemble/ensemble_10000", problem_name, "multistart_$experiment_name","models", "model_1_p_opt.jld2"), "p_opt")
